...
In a **new terminal** (keep Riva and vLLM running), clone the [Multi-modal AI Studio](https://github.com/NVIDIA-AI-IOT/multi_modal_ai_studio) repository, set up, and start the application:
