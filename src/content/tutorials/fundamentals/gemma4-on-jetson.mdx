...
If you are using streaming, you are generally good. If you are not, you should look out for cases where the model's thought text can leak into `content` instead of being cleanly separated from the final answer.
