...
supported_inference_engines:
  - engine: "Ollama"
    ...
    run_command: "ollama run gemma3:4b"
  - engine: "vLLM"
    type: "Container"
    modules_supported:
      - thor_t5000
      ...
      - orin_nx_16
      - orin_nano_8
    run_command_orin: "sudo docker run -it --rm --pull always --runtime=nvidia --network host ghcr.io/nvidia-ai-iot/vllm:latest-jetson-orin vllm serve RedHatAI/gemma-3-4b-it-quantized.w4a16"
    run_command_thor: "sudo docker run -it --rm --pull always --runtime=nvidia --network host ghcr.io/nvidia-ai-iot/vllm:latest-jetson-thor vllm serve RedHatAI/gemma-3-4b-it-quantized.w4a16"
---
